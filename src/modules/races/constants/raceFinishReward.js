...
// as daily rewards (src/modules/economy/constants/dailyReward.js) and step milestones
// (src/modules/steps/constants/stepMilestones.js). On completion the pool is split across the
