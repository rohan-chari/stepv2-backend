...
const RARITY_TIERS = {
  ...
  UNCOMMON: ["LEG_CRAMP", "STEALTH_MODE", "WRONG_TURN", "CLEANSE"],
  RARE: ["RED_CARD", "SECOND_WIND", "COMPRESSION_SOCKS", "FANNY_PACK", "LUCKY_HORSESHOE", "POCKET_WATCH", "TRAIL_MINE", "SNEAKY_SWAP", "SHORTCUT", "MIRROR"],
};
