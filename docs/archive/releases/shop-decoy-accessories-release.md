...
Deployment completed2026-09-10 at19:38UTC, runtime6a0f6c39df749f0abbabe59e935d1341d1347379, tagged deploy/shop-decoy-accessories-20260910-6a0f6c3. Both migrations succeeded, checksums match source, concurrent index valid/ready. Live legacy/current catalog GETs200; current Decoy150 with updated one-hour description; testOnlyfalse and daily reward exclusion preserved. Health/Redis okay, two HTTP workers and one each resolution/cron online, staging stopped. Environment and remote package-lock preserved. Deploy backend before TestFlight build18; preserve exactly two HTTP workers and stopped staging. Verify both migration checksums/index validity, live base price150, legacy/current GET catalog behavior, refreshed description (existing60s cache), health and worker topology.
