...
describe("feature batch 2026-07-24 — powerups", () => {
  ...
  describe("item 7 — stealth durations", () => {
    ...
    // The current balance ladder uses 15-minute increments above the 60-minute
    // base: 60/75/90/105 minutes.
    it("upgraded stealth follows the 60/75/90/105-minute ladder for a modern client", async () => {
      ...
      const expected = [60 * MIN, 75 * MIN, 90 * MIN, 105 * MIN];
