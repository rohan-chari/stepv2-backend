...
const TABLES_IN_ORDER = [
  ...
  "global_step_event_generation_state",
  "global_step_event_entitlements",
  "race_effect_impacts",
  "race_impact_events",
  "historical_effect_corrections",
  "historical_effect_contributions",
  "historical_race_discovery_cursors",
  "historical_race_reconciliation_intents",
  ...
  "race_admin_commands",
  "referral_qualification_intents",
  "referral_qualification_facts",
  "race_messages",
  "race_powerup_events",
  "race_active_effects",
  "race_powerups",
  ...
  "giveaway_rate_windows",
  "giveaway_idempotency_receipts",
  "giveaway_audit_events",
  "giveaway_fulfillments",
  "giveaway_results",
  "giveaway_point_reviews",
  "giveaway_entrants",
  "giveaway_contests",
