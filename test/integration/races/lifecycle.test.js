...
// ---- consolidated from scheduled-race-late-start.test.js ----
(function scheduled_race_late_start_test_js(){
...
// ---- consolidated from race-ending-soon-skips-seeded.test.js ----
(function race_ending_soon_skips_seeded_test_js(){
const assert = require("node:assert/strict");
const { describe, it, before, beforeEach } = require("node:test");
...
// ---- consolidated from batch-0808-completed-participants.test.js ----
(function batch_0808_completed_participants_test_js(){
const assert = require("node:assert/strict");
const { describe, it, before, beforeEach } = require("node:test");
const { cleanDatabase, prisma, request, getSharedServer } = require("../setup");
...
// ---- consolidated from batch-0808-private-race-autostart.test.js ----
(function batch_0808_private_race_autostart_test_js(){
const assert = require("node:assert/strict");
