...
const EXPECTED_PARTICIPANT_MUTATIONS = {
  ...
  "src/modules/races/commands/editRace.js": ["participantModel.update"],
  ...
  "src/modules/races/jobs/raceResolutionQueueV2.js": ["raceParticipant.update", "raceParticipant.update"],
  ...
  "src/modules/races/models/raceParticipant.js": ["raceParticipant.create", "raceParticipant.createMany", "raceParticipant.delete", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.update", "raceParticipant.updateMany", "raceParticipant.updateMany"],
  "src/modules/races/services/commitRaceStart.js": ["raceParticipant.update"],
  "src/modules/races/services/fundedExposure.js": ["raceParticipant.update", "tournamentParticipant.update"],
  ...
  "src/modules/races/services/seededRaceBuckets.js": ["raceParticipant.create", "raceParticipant.delete"],
...
const NON_MEMBERSHIP_PARTICIPANT_WRITERS = new Set([
  ...
  "src/modules/races/commands/editRace.js",
